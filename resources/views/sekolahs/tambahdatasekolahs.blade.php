    ...
    <div class="container-fluid">
        <div class="page-titles">
            <ol class="breadcrumb">
                ...
                <li class="breadcrumb-item active"><a href="/sekolahs">Sekolah dan PNHB</a></li>
            ...
            <div class="card-body">
                <form action="/insertdatasekolahs" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="mb-3">
                            ...
                            <input type="text" name="kegiatan" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
                    </div>
                            @error('kegiatan')
                                <div class="alert alert-danger">{{ $message }}</div>
                            @enderror

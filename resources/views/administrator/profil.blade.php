                ...
                <div class="col-lg-12">
                    <div class="profile card card-body px-3 pt-3 pb-0">
                        <div class="profile-head">
                            ...
                            width: 100%;
                            height:300px; "
                                    src="{{ asset('fotosekolah/' . Auth::user()->fotosampul) }}" alt="">
                            </div>
                            <div class="profile-info">
                                <div class="profile-photo">
                                    <img style="width: 120px;
                                height:100px;"
                                        src="{{ (Auth::user()->foto) ? asset('fotosekolah/'. Auth::user()->foto ) : asset('fotosekolah/admin.png') }}"
                                        class="img-fluid rounded-circle" alt="">
                                </div>
                                <div class="profile-details">
                                    <div class="profile-name px-3 pt-2">
                                        <h4 class="text-primary mb-0">{{ Auth::user()->name }}</h4>
                                        <p>Super {{ Auth::user()->role }}</p>
                                    </div>
                                    ...
                                    <div class="dropdown ml-auto">
                                        ...
                                        <ul class="dropdown-menu dropdown-menu-right">
                                            <li onclick="pilihFoto()" class="dropdown-item"><i
                                                    class="fa fa-user-circle text-primary mr-2"></i>
                                                <label for="">Ubah Foto Profil</label>
                                            </li>
                                            <li onclick="pilihFoto1()" class="dropdown-item"><i
                                                    style="margin-right: 4px;
                                            color:#0b2a97;"
                                                    class="fa-solid fa-chalkboard-user"></i> Ubah Foto Sampul</li>
                                            <li data-toggle="modal" data-target="#exampleModalCenter" class="dropdown-item">
                                                <i style="margin-right: 6px;
                                            color:#0b2a97;
                                            margin-left:2px;"
                                                    class="fa-solid fa-list"></i> Ubah Nama
                                            </li>
                                            <li data-toggle="modal" data-target="#exampleModalCenter1"
                                                class="dropdown-item"><i style="margin-right: 7px;color:#0b2a97;"
                                                    class="fa-solid fa-key"></i> Ubah Password</li>
                                        </ul>

                                        <form method="POST" action="/updatenama" class="modal fade"
                                                ...
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        <input value="{{ Auth::user()->name }}" name="name"
                                                            class="form-control input-default" type="text">
                                                    </div>
                                        ...
                                        <form method="POST" action="/updatepassword" class="modal fade"
                                            ...
                                            <div class="modal-dialog modal-dialog-centered" role="document">
                                                <div class="modal-content">
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input name="current_password" class="form-control input-default"
                                                            type="password">
                                                    </div>

                                                    <div class="modal-body">
                                                        <label for="">Password Baru</label>
                                                        <input name="password" class="form-control input-default"
                                                            type="password">
                                                    </div>
                                                    ...
                                                    <div class="modal-body">
                                                        ...
                                                        <input name="password_confirmation"
                                                            class="form-control input-default" type="password">
                                                    </div>
                                        ...
                                        <form id="ubah-foto" action="/updatefoto" method="post"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="file" name="foto"
                                                onchange="document.getElementById('ubah-foto').submit()" id="pilih-foto"
                                                style="display: none;">
                                        </form>

                                        <form id="ubah-foto1" action="/updatefotosampul" method="post"
                                            enctype="multipart/form-data">
                                            @csrf
                                            <input type="file" name="fotosampul"
                                                onchange="document.getElementById('ubah-foto1').submit()" id="pilih-foto1"
                                                style="display: none;">
                                        </form>

                                        {{-- <button type="button" id="tombol-pilih-foto">Pilih Foto Profil</button> --}}
                                        <script>
                                            function pilihFoto() {
                                                var input = document.getElementById("pilih-foto");
                                                input.click();
                                            }
                                        </script>
                                        <script>
                                            function pilihFoto1() {
                                                var input = document.getElementById("pilih-foto1");
                                                input.click();
                                            }
                                        </script>
                                    </div>
                    ...
                    <div class="card">
                        <div class="card-body">
                            ...
                            <div class="profile-blog mb-5">
                                ...
                                <img src="{{ asset('template/nabil/xhtml/images/profile/1.jpg') }}" alt=""
                            ...
                            <div class="profile-interest mb-5">
                                ...
                                <div class="row mt-4 sp4" id="lightgallery">
                                    <a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg"
                                        data-src="{{ asset('template/nabil/xhtml/images/profile/2.jpg') }}"
                                        class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                        <img src="{{ asset('template/nabil/xhtml/images/profile/2.jpg') }}" alt=""
                                            class="img-fluid">
                                    </a>
                                    <a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg"
                                        data-src="{{ asset('template/nabil/xhtml/images/profile/3.jpg') }}"
                                        class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                        <img src="{{ asset('template/nabil/xhtml/images/profile/3.jpg') }}"
                                            alt="" class="img-fluid">
                                    </a>
                                    <a href="images/profile/4.jpg" data-exthumbimage="images/profile/4.jpg"
                                        data-src="{{ asset('template/nabil/xhtml/') }}images/profile/4.jpg"
                                        class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                        <img src="{{ asset('template/nabil/xhtml/') }}images/profile/4.jpg"
                                            alt="" class="img-fluid">
                                    </a>
                                    <a href="images/profile/3.jpg" data-exthumbimage="images/profile/3.jpg"
                                        data-src="{{ asset('template/nabil/xhtml/') }}images/profile/3.jpg"
                                    ...
                                    <a href="images/profile/2.jpg" data-exthumbimage="images/profile/2.jpg"
                                        data-src="{{ asset('template/nabil/xhtml/') }}images/profile/2.jpg"
                                        class="mb-1 col-lg-4 col-xl-4 col-sm-4 col-6">
                                        <img src="{{ asset('template/nabil/xhtml/') }}images/profile/2.jpg"
                                            alt="" class="img-fluid">
                                    </a>
                                </div>
                            </div>
                            <div class="profile-news">
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('template/nabil/xhtml/') }}images/profile/5.jpg" alt="image"
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('template/nabil/xhtml/') }}images/profile/6.jpg" alt="image"
                                        class="mr-3 rounded" width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of
                                                textile samples</a></h5>
                                ...
                                <div class="media pt-3 pb-3">
                                    <img src="{{ asset('template/nabil/xhtml/') }}images/profile/7.jpg" alt="image"
                                        class="mr-3 rounded" width="75">
                                    <div class="media-body">
                                        <h5 class="m-b-5"><a href="post-details.html" class="text-black">Collection of
                                                textile samples</a></h5>
                                        ...
                                        <div id="my-posts" class="tab-pane fade active show">
                                            <div class="my-post-content pt-3">
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    <img src="{{ asset('template/nabil/xhtml/') }}images/profile/8.jpg"
                                                        alt="" class="img-fluid">
                                                ...
                                                <div class="profile-uoloaded-post border-bottom-1 pb-5">
                                                    <img src="{{ asset('template/nabil/xhtml/') }}images/profile/9.jpg"
                                                        alt="" class="img-fluid">
                                                    <a class="post-title" href="post-details.html">
                                                        <h3 class="text-black">Collection of textile samples lay spread
                                                        </h3>

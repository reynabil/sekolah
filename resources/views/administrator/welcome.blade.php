                                ...
                                <div class="card-body">
                                    <div class="media align-items-center">
                                        <span class="activity-icon bgl-success mr-md-4 mr-3">
                                            ...
                                            color: green;"
                                                class="fa-solid fa-newspaper fa-3x"></i>
                                        ...
                                        <div class="media-body">
                                            <p class="fs-14 mb-2">Jumlah Berita</p>
                                            <span class="title text-black font-w600">{{ $berita }}</span>
                                        </div>
                                    </div>
                                    <div class="progress" style="height:5px;">
                                        <div class="progress-bar bg-success"
                                            style="width: {{ $berita }}%; height:5px;" role="progressbar">
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <span class="activity-icon bgl-secondary  mr-md-4 mr-3">
                                                <i style="margin-top: 15px;
                                            color: mediumpurple;"
                                                    class="fa-solid fa-paperclip fa-3x"></i>
                                                <path
                                            ...
                                            <div class="media-body">
                                                <p class="fs-14 mb-2">Jumlah Artikel</p>
                                                <span class="title text-black font-w600">{{ $artikel }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
                                            <div class="progress-bar bg-secondary"
                                                style="width: {{ $artikel }}%; height:5px;" role="progressbar">
                                                <span class="sr-only">42% Complete</span>
                                            </div>
                                        </div>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            <span class="activity-icon bgl-danger mr-md-4 mr-3">
                                                <i style="margin-top:15px;
                                            color: #F94687"
                                                    class="fa-solid fa-image fa-3x"></i>
                                                <path
                                            ...
                                            <div class="media-body">
                                                <p class="fs-14 mb-2">Jumlah Foto Di Galeri</p>
                                                <span class="title text-black font-w600">{{ $galeri }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
                                            <div class="progress-bar bg-danger"
                                                style="width: {{ $galeri }}%; height:5px;" role="progressbar">
                                                <span class="sr-only">42% Complete</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card avtivity-card">
                                    <div class="card-body">
                                        <div class="media align-items-center">
                                            ...
                                            margin-top:18px;"
                                                    class="fa-solid fa-message fa-3x"></i>
                                                <path
                                            ...
                                            <div class="media-body">
                                                <p class="fs-14 mb-2">Jumlah Pesan</p>
                                                <span class="title text-black font-w600">{{ $pesan }}</span>
                                            </div>
                                        </div>
                                        <div class="progress" style="height:5px;">
                                            <div class="progress-bar bg-warning"
                                                style="width: {{ $pesan }}%; height:5px;" role="progressbar">
                                                <span class="sr-only">42% Complete</span>
                                            </div>
                                        </div>
                                    </div>
                                ...
                                <div class="card-body loadmore-content height750 dz-scroll pt-0"
                                    ...
                                    <div class="media mb-4">
                                        <img src="images/menus/1.png" width="85" alt=""
                                            class="rounded mr-3">
                                        <div class="media-body">
                                            <h5><a href="food-menu.html" class="text-black fs-16">Chinese Orange Fruit
                                                    With Avocado Salad</a></h5>
                                    ...
                                    <div class="media mb-4">
                                        <img src="images/menus/2.png" width="85" alt=""
                                            class="rounded mr-3">
                                        <div class="media-body">
                                            <h5><a href="food-menu.html" class="text-black fs-16">Fresh or Frozen (No
                                                    Sugar Added) Fruits</a></h5>

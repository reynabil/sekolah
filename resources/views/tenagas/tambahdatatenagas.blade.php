...
<div class="content-body">
    <div class="container-fluid">
        ...
        <div class="card">
            ...
            <div class="card-body">
                <form action="/insertdatatenagas" method="POST" enctype="multipart/form-data">
                    @csrf
                    <div class="mb-3">
                    ...
                    <div class="mb-3">
                        ...
                        <div class="mb-3">
						<label for="exampleInputEmail1" class="form-label"><h5>Status</h5></label>
                    ...
                    <div class="mb-3">
						...
						<input type="date" name="tmt" class="form-control" id="exampleInputEmail1" aria-describedby="emailHelp">
					</div>
						@error('tmt')
							<div class="alert alert-danger">{{ $message }}</div>
						@enderror

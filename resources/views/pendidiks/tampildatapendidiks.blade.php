    ...
    <div class="content-body">
        <div class="container-fluid">
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/updatedatapendidiks/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">
                        ...
                        @enderror
                            ...
                            <div class="mb-3">
                                ...
                                <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label"><h5>Pangkat</h5></label>
                                <input type="text" name="pangkat" class="form-control" id="exampleInputEmail1" value="{{ $data->pangkat}}" aria-describedby="emailHelp">
                            </div>
                                @error('pangkat')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror
                                ...
                                <div class="mb-3">
                                <label for="exampleInputEmail1" class="form-label"><h5>Tugas</h5></label>
                                <input type="text" name="tugas" class="form-control" id="exampleInputEmail1" value="{{ $data->tugas}}" aria-describedby="emailHelp">
                            </div>
                                @error('tugas')
                                <div class="alert alert-danger">{{ $message }}</div>
                                @enderror

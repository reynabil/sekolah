        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="/kelasxes">Data Tenaga Non Pendidik</a></li>
            ...
            <div class="card">
                ...
                <div class="card-body">
                    <form action="/updatedatakelasxes/{{ $data->id }}" method="POST" enctype="multipart/form-data">
                        @csrf
                        <div class="mb-3">

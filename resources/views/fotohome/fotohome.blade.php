            ...
            <div class="card">
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <a href="/tambahfotohome"><button class="btn btn-success mb-3">Tambah Data</button></a>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->judul }}</td>
                                        <td>
                                            <img src="{{ asset('foto_home/' . $row->foto) }}" alt=""
                                                style="width: 400px;
                                                height: 200px;";>
                                        </td>

                                        <td>
                                            <a href="/tampilfotohome/{{ $row->id }}" class="btn btn-warning"><i
                                                    class="fa-sharp fa-solid fa-pen-to-square"></i></a>
                                            <a href="#" class="btn btn-danger delete" data-id="{{ $row->id }}"
                                                data-nama_dosen="{{ $row->nama_dosen }}we"><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletefotohome/" + mahasiswaid + ""

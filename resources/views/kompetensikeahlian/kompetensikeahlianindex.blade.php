                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-responsive-sm">
                            <a href="/tambahkompetensi" class="btn btn-success mb-5">Tambah Data</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>foto</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        <th scope="row">{{ $no++ }}</th>
                                        <td>
                                            <img src="{{ asset('fotokompetensi/' . $row->foto) }}" alt=""
                                                style="width: 100px";>
                                        </td>
                                        <td>{{ $row->nama_jurusan }}</td>
                                        <td>
                                            <img style="width: 500px;
                                            height: 200px;" src="{{ asset('fotokompetensi/' . $row->foto_detail) }}" alt="">
                                        </td>
                                        <td>{!! $row->deskripsi !!}</td>
                                        <td>
                                            <a href="/tampilkompetensi/{{ $row->id }}" class="btn btn-warning mb-3"><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletekompetensi/" + mahasiswaid + ""

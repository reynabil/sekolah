        ...
        <div id="rev_slider_34_1" class="rev_slider" data-version="5.0.7">
            <ul>
                ...
                <li data-index="rs-129">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('banner/'. $slider->slider1) }}"
                    ...
                    <div class="tp-caption Newspaper-Title tp-resizeme " id="slide-129-layer-1"
                        ...
                        <div class="banner-text"> <span class="sub-text">Selamat Datang Di</span>
                            <h2>SMKN <span>1 </span> KOTA<span> PASURUAN</span></h2>
                            <p> Jl. Veteran, Bugul Lor, Kec. Panggungrejo, Kota Pasuruan, Jawa Timur 67122</p>
                            <a class="btn-text" href="/sejarah">Tentang kamI</a>
                        </div>
                    </div>
                </li>
                <!-- SLIDE  -->
                <li data-index="rs-130" data-title="" data-description="">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('banner/'. $slider->slider2) }}"
                        alt="" class="rev-slidebg">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 2 -->
                ...
                <li data-index="rs-131">
                    <!-- MAIN IMAGE -->
                    <img src="{{ asset('banner/'. $slider->slider3) }}"
                        alt="" class="rev-slidebg ">
                    <!-- LAYERS -->
                    <!-- LAYER NR. 2 -->
                    <div class="tp-caption Newspaper-Title   tp-resizeme " id="slide-131-layer-1"
                        ...
                        data-start="1000" data-splitin="none" data-splitout="none" data-responsive_offset="on">
                        <div class="banner-text"> <span class="sub-text"></span>
                            <h2>Kompetensi <span>Keahlian</span> <span></span></h2>
                            <p> Terdapat 7 kompetensi keahlian Di SMKN 1 Pasuruan yaitu :
                                Teknik Komputer Jaringan(TKJ),Desain Komunikasi Visual(DKV),Bisnis Daring
                                Pemasaran(BDP),
                                Kimia Analisis dan Kimia Industri(KA/KI),Rekayasa Dan Perangkat Lunak(RPL),Akuntansi Dan

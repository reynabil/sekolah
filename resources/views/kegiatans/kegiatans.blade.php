        ...
        <div class="container-fluid">
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Kegiatan Keagamaan</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-responsive-sm">
                            <a href="/tambahdatakegiatans" class="btn btn-success mb-5">Tambah Data</a>
                            <thead>
                                <tr>
                                    <th>#</th>
									<th>Tanggal</th>
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletekegiatans/" + mahasiswaid + ""

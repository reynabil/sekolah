        ...
        <div class="container-fluid">
            <div class="page-titles">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active"><a href="/empats">Bahan Ajar Kelas XIII Kimia</a></li>
                </ol>
            </div>
            <!-- row -->
            ...
            <div class="card">
                <div class="card-header">
                    <h4 class="card-title">Bahan Ajar Kelas XIII Kimia</h4>
                </div>
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-responsive-sm">
                            <a href="/tambahdataempats" class="btn btn-success mb-5">Tambah Data</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Foto</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="/tampildataempats/{{ $row->id }}" class="btn btn-warning mb-3"><i

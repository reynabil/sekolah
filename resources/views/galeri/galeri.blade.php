                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered table-responsive-sm">
                            <a href="/tambahgaleri" class="btn btn-success mb-5">Tambah Data</a>
                            <thead>
                                <tr>
                                    <th>#</th>
                                    <th>Judul</th>
                            ...
                            <tbody>
                                ...
                                @foreach ($data as $row)
                                    <tr>
                                        ...
                                        <td>{{ $row->judul }}</td>
                                        <td>
                                            <img src="{{ asset('fotogaleri/' . $row->foto) }}" alt=""
                                                style="width: 200px";>
                                        </td>
                                        <td>
                                            <a href="/tampilgaleri/{{ $row->id }}" class="btn btn-warning "><i
    ...
    <script>
        $('.delete').click(function() {
            ...
            swal({
                ...
                .then((willDelete) => {
                    if (willDelete) {
                        window.location = "/deletegaleri/" + mahasiswaid + ""

...
<head>
	...
	<link href="{{ asset('template/nabil/xhtml/https://fonts.googleapis.com/css2?family=Poppins:wght@100;200;300;400;500;600;700;800;900&amp;family=Roboto:wght@100;300;400;500;700;900&amp;display=swap') }}" rel="stylesheet">
</head>
<body>
				...
				<div class="tab-content">
					<div class="tab-pane fade active show" id="chat" role="tabpanel">
						...
						<div class="card chat dz-chat-history-box d-none">
							<div class="card-header chat-list-header text-center">
								<a href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}" class="dz-chat-history-back">
								...
								<ul class="contacts">
									<li class="active">
										<div class="d-flex bd-highlight">
											...
											<div class="ml-auto">
												<a href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}" class="btn btn-primary btn-xs sharp mr-1"><i class="fa fa-pencil"></i></a>
												<a href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}" class="btn btn-danger btn-xs sharp"><i class="fa fa-trash"></i></a>
											</div>
										</div>
									</li>
									<li>
                        ...
                        <ul class="navbar-nav header-right">
							<li class="nav-item">
								<div class="input-group search-area d-xl-inline-flex d-none">
									<div class="input-group-append">
										<span class="input-group-text"><a href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}"><i class="flaticon-381-search-2"></i></a></span>
									</div>
									<input type="text" class="form-control" placeholder="Search here...">
								</div>
							</li>
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link  ai-icon" href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}" role="button" data-toggle="dropdown">
                                ...
                                <div class="dropdown-menu rounded dropdown-menu-right">
                                    ...
                                    <a class="all-notification" href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}">See all notifications <i class="ti-arrow-right"></i></a>
                                </div>
                            </li>
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link bell bell-link" href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}">
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
							...
							<li class="nav-item dropdown notification_dropdown">
                                <a class="nav-link" href="{{ asset('template/nabil/xhtml/javascript:void(0)') }}" data-toggle="dropdown">
                                    <svg width="28" height="28" viewBox="0 0 28 28" fill="none" xmlns="http://www.w3.org/2000/svg">
